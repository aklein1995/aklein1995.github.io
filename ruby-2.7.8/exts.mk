...
ECHO1 = $(V:1=@:)
ECHO = $(ECHO1:0=@echo)
extensions = ext/syslog/. ext/digest/. ext/digest/bubblebabble/. \
	     ext/digest/md5/. ext/digest/rmd160/. ext/digest/sha1/. \
	     ext/digest/sha2/. ext/io/console/. ext/io/nonblock/. \
	     ext/io/wait/. ext/json/. ext/json/generator/. \
	     ext/json/parser/. ext/monitor/. ext/socket/. ext/nkf/. \
	     ext/gdbm/. ext/strscan/. ext/stringio/. ext/cgi/escape/. \
	     ext/etc/. ext/pathname/. ext/bigdecimal/. \
	     ext/continuation/. ext/zlib/. ext/ripper/. ext/coverage/. \
	     ext/pty/. ext/rbconfig/sizeof/. ext/openssl/. ext/date/. \
	     ext/psych/. ext/dbm/. ext/objspace/. ext/racc/cparse/. \
	     ext/-test-/arith_seq/extract/. ext/-test-/array/resize/. \
	     ...
	     ext/-test-/wait_for_single_fd/. ext/rubyvm/. ext/fcntl/. \
	     ext/sdbm/. ext/fiber/. ext/readline/. ext/fiddle/.
EXTOBJS = dmyext.o
...
note-body:: note-header
	...
	@echo "	/home/109499@TRI.LAN/Github/aklein1995.github.io/ruby-2.7.8/ext/openssl/extconf.rb:111: OpenSSL >= 1.0.1, < 3.0.0 or LibreSSL >= 2.5.0 is required"
